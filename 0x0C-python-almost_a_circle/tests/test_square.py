...
"""a classes for unitest for the square object.
...
class test_insatnce(unittest.TestCase):
    """Unittests for testing the insatnce the class object."""
...
class testforsize(unittest.TestCase):
    """Unittests for testing size constructor."""
...
class test_xvalue(unittest.TestCase):
    """Unittests for testing the value init of x value."""
...
class test_yvalue(unittest.TestCase):
    """Unittests for testing the value init of y value."""
